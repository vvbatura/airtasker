<template>
    <header id="header">
        <div class="container align-items-center justify-content-between d-flex">
            <div class="d-flex align-items-center visible_header">
                <div id="logo" class="logo_header">
                    <router-link class="logo" to="/">
                        <!-- <img src="img/white-logo.svg" alt="" /> -->
                        <svg id="AirtaskerLogo" width="111" height="19" viewBox="0 0 141 23" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" data-ui-test="undefined-svg">
                            <g fill-rule="evenodd">
        ...
        <modal
            ...
            <div class="container modal_menu d-flex justify-content-between"> 
                <div class="hide_menu">
                    <div id="logo_hide" class="logo_header">
                        <router-link class="logo" to="/">
