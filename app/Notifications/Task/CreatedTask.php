...
class CreatedTask extends Notification implements ShouldQueue
{
    use Queueable;
    use NexmoTrait;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ->subject('Created Task Success')
            ->greeting('Hello,'. $this->user->getFirstName() . '!'.trans('auth.test'))
            ->line('You created task success!')
    ...
    {
        $message = trans('auth.test') . ' You created task success! Thank you for using our application!';
