...
class ResetPasswordSuccess extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ->subject('Changed Password Success')
            ->greeting('Hello,'. $this->user->getFirstName() . '!')
            ->line('Your password changed success!')
    ...
    {
        $message = trans('auth.test') . ' Your changed password success! Thank you for using our application!';
